...
## Deployment
The application is deployed and can be accessed using the following link: <a href="https://chat-app-tal.netlify.app/" target="_blank" rel="noreferrer noopener">Chat-App</a> 
